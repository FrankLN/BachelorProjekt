...
namespace WebApp.Controllers
{
    ...
    {
        private WebApp.Models.pacemakerdataEntities dbModel = new Models.pacemakerdataEntities();

        //// Mockup data created
        //protected List<Models.DbModel> getFromDB()
        //{
        //    List<Models.DbModel> result = new List<Models.DbModel>();

        //    result.Add(new Models.DbModel() { EpisodeType = "Aterial fibrillation", TransmissionId = 1, Date = "20150918153452", Patient = "Egon Olsen" });
        ...
        public ActionResult Index()
        {
            ...
            string d = dbModel.pacemakerdataview.Min(m => m.episodeDate);
            d = d.Substring(6, 2) + "/" + d.Substring(4, 2) + "/" + d.Substring(0, 4);

            string de = dbModel.pacemakerdataview.Max(m => m.episodeDate);
